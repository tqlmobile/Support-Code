...
- (void)applyWithMode:(ATMHudApplyMode)mode andAnimate:(Boolean)animate {
	switch (mode) {
...
- (void)show {
	[self calculate];
	[self applyWithMode:ATMHudApplyModeShow andAnimate:YES];
}

- (void)hide {
	[self applyWithMode:ATMHudApplyModeHide andAnimate:YES];
}

- (void)showAndAnimate:(Boolean)animate {
	[self calculate];
	[self applyWithMode:ATMHudApplyModeShow andAnimate:animate];
}

- (void)hideAndAnimate:(Boolean)animate {
	[self applyWithMode:ATMHudApplyModeHide andAnimate:animate];
}

- (void)update {
	[self calculate];
	[self applyWithMode:ATMHudApplyModeUpdate andAnimate:YES];
}
